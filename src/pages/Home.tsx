      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-8">
            Precisa de mais profissionais para seu pet?
          </h2>
          <p className="text-xl text-gray-600 mb-8">
            Encontre especialistas qualificados para cuidar do seu animal
          </p>
          ...
          <Card className="shadow-xl border-0 mb-8">
            <CardContent className="p-8">
              <div className="flex justify-center items-center gap-8 mb-6">
                ...
                <div className="text-center">
                  <div className="text-3xl mb-2">🩺</div>
                  <div className="text-sm text-gray-600">Veterinários</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl mb-2">✂️</div>
                  <div className="text-sm text-gray-600">Pet Groomers</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl mb-2">🎾</div>
                  <div className="text-sm text-gray-600">Dog Walkers</div>
                </div>
              </div>
              <p className="text-gray-700 mb-6">
                Conecte-se com profissionais especializados em cuidados pet com preços a partir de R$ 25/hora
              </p>
          ...
          {/* Nova seção para se cadastrar como profissional */}
          <Card className="shadow-xl border-0">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Quer se tornar um profissional pet?
              </h3>
              <p className="text-gray-700 mb-6">
                Cadastre-se em nossa plataforma e comece a ganhar dinheiro cuidando de pets
              </p>
